...
### Individual Commands
For all other commands (`/market copy`, `/market emails`, etc.), read and follow the instructions in the corresponding skill file at `.claude/commands/market-<command>.md`.
